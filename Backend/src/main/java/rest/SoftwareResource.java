...
public class SoftwareResource {
    ...
    public String setupDatabase() {
        ...
        softwares.add(new Software("Word", "Program for words", 10000, "https://d1yjjnpx0p53s8.cloudfront.net/styles/logo-thumbnail/s3/072015/word_0.png?itok=YCX08sq9"));
        softwares.add(new Software("Excel", "Program for numbers", 10000, "https://teaching.cambriancollege.ca/wp-content/uploads/2018/07/Top-of-Page-Images.jpg"));
        softwares.add(new Software("PowerPoint", "Program for presentation", 100000, "https://www.tcd.ie/CAPSL/TIC/assets/img/accessible-info/powerpoint.png"));
        softwares.add(new Software("WinRar", "Program for rar files", 0, "https://cdn.worldvectorlogo.com/logos/winrar-1.svg"));
